export const en = {
  ...
  'conn.parseError': 'Unrecognized format. Expected: postgresql://user:pass@host:port/db or mongodb+srv://user:pass@cluster/db',
  ...
  'conn.hostOrUri': 'Host or URI',
  'conn.hostOrUriPlaceholder': 'localhost or mongodb+srv://cluster0.example.net',
  'conn.mongoDatabaseHint': '(optional — "test" by default)',
  'conn.mongoDatabasePlaceholder': 'test',
  'conn.redisHostPlaceholder': 'localhost or redis://:password@host:6379/0',
  'conn.redisDb': 'Database index',
  'conn.redisDbHint': '(optional — 0 by default)',
  'conn.mssqlHostPlaceholder': 'server or server\\INSTANCE',
  'conn.account': 'Account',
  'conn.accountPlaceholder': 'myorg-myaccount or its URL',
  'conn.snowflakeDatabaseHint': '(database or database/schema — required for the schema browser)',
  'conn.snowflakeDatabasePlaceholder': 'ANALYTICS or ANALYTICS/PUBLIC',
  'conn.warehouse': 'Warehouse',
  'conn.role': 'Role',
  'conn.passwordOrKey': 'Password or private key',
  'conn.passwordOrKeyPlaceholder': 'Password, or a PEM key (-----BEGIN PRIVATE KEY-----…)',
  ...
  'sel.copyAsMongo': 'Copy as mongosh',
  'sel.copyAsRedis': 'Copy as redis-cli',
  'sel.export': 'Export',
  'sel.exportAsCsv': 'Export as CSV',
  'sel.exportAsJson': 'Export as JSON',
  'sel.exportAsSql': 'Export as SQL',
  'sel.exportAsMongo': 'Export as mongosh script',
  'sel.exportAsRedis': 'Export as redis-cli commands',
  'table.noPrimaryKey': 'No known primary key for this table: it cannot be edited.',
  ...
  // ── Sync ──
  'sync.title': 'Data Synchronisation',
  'sync.tooltip': 'Synchronise data between connections',
  'sync.source': 'Source',
  'sync.target': 'Target',
  'sync.selectConnection': 'Select a connection',
  'sync.fetchingSchema': 'Fetching schema…',
  'sync.noTables': 'No tables found on the source.',
  'sync.tables': 'Tables to synchronise',
  'sync.selectAll': 'Select all',
  'sync.deselectAll': 'Deselect all',
  'sync.start': 'Synchronise',
  'sync.syncing': 'Synchronising…',
  'sync.done': 'Synchronisation complete',
  'sync.error': 'Synchronisation failed',
  'sync.tableStatus.pending': 'Pending',
  'sync.tableStatus.schema': 'Reading schema…',
  'sync.tableStatus.create': 'Creating table…',
  'sync.tableStatus.insert': 'Inserting data…',
  'sync.tableStatus.done': 'Done',
  'sync.tableStatus.error': 'Error',
  'sync.rows': 'rows',
  'sync.modeStructure': 'Structure only',
  'sync.modeStructureData': 'Structure + Data',
  'sync.includeConstraints': 'Include indexes and foreign keys',
  'sync.database': 'Database',
  'sync.warning': 'Target tables will be dropped and recreated. This is irreversible.',
  ...
  'dbusers.notSupported': 'Database user management is not supported for this kind of database.',
