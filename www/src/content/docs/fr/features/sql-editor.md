...
L'editeur SQL est le coeur de dblumi. Il supporte PostgreSQL, MySQL, Oracle, SQLite et Trino avec coloration syntaxique, auto-completion et streaming des resultats en temps reel.

![Editeur SQL avec coloration syntaxique et resultats](/dblumi/images/feature-editor.png)

## Fonctionnalites cles

- **Coloration syntaxique** pour PostgreSQL, MySQL, Oracle, SQLite et Trino SQL (la grammaire PostgreSQL est utilisee pour SQLite et Trino)
